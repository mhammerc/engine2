...
void Mesh::setupMesh() {
    ...
    );  // position of the components in the struct

    glEnableVertexAttribArray(1);
    glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, sizeOfVertex, reinterpret_cast<void*>(offsetof(Vertex, normal)));

    glEnableVertexAttribArray(2);
    glVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, sizeOfVertex, reinterpret_cast<void*>(offsetof(Vertex, texCoords)));
