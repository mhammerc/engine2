 ...
 * 7) Postprocess pass: perform the tone mapping, HDR scaling, and more.
 * 8) Outline pass: draw a nice outline around objects that were selected to be outlined in gbuffers.
 *
 * 9) We then copy two texture to the destination framebuffer:
