...
static void GLAD_API_PTR glad_debug_impl_glActiveShaderProgram(GLuint pipeline, GLuint program) {
    ...
    _post_call_gl_callback(
        ...
        (GLADapiproc)glad_glActiveShaderProgram,
        2,
        pipeline,
        program
    );
...
static void GLAD_API_PTR glad_debug_impl_glBeginTransformFeedback(GLenum primitiveMode) {
    ...
    _post_call_gl_callback(
        ...
        (GLADapiproc)glad_glBeginTransformFeedback,
        1,
        primitiveMode
    );
}
...
glad_debug_impl_glBindBufferRange(GLenum target, GLuint index, GLuint buffer, GLintptr offset, GLsizeiptr size) {
    _pre_call_gl_callback(
        "glBindBufferRange",
        (GLADapiproc)glad_glBindBufferRange,
        5,
        target,
        index,
        buffer,
...
static void GLAD_API_PTR glad_debug_impl_glBindFragDataLocation(GLuint program, GLuint color, const GLchar* name) {
    ...
    _post_call_gl_callback(
        ...
        (GLADapiproc)glad_glBindFragDataLocation,
        3,
        program,
        color,
        name
...
glad_debug_impl_glBindFragDataLocationIndexed(GLuint program, GLuint colorNumber, GLuint index, const GLchar* name) {
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glBindFragDataLocationIndexed,
        4,
        program,
        colorNumber,
        index,
...
static void GLAD_API_PTR glad_debug_impl_glBlendEquationSeparate(GLenum modeRGB, GLenum modeAlpha) {
    ...
    _post_call_gl_callback(
        ...
        (GLADapiproc)glad_glBlendEquationSeparate,
        2,
        modeRGB,
        modeAlpha
    );
...
static void GLAD_API_PTR glad_debug_impl_glBlendEquationSeparatei(GLuint buf, GLenum modeRGB, GLenum modeAlpha) {
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glBlendEquationSeparatei,
        3,
        buf,
        modeRGB,
        modeAlpha
...
glad_debug_impl_glBlendFuncSeparate(GLenum sfactorRGB, GLenum dfactorRGB, GLenum sfactorAlpha, GLenum dfactorAlpha) {
    _pre_call_gl_callback(
        "glBlendFuncSeparate",
        (GLADapiproc)glad_glBlendFuncSeparate,
        4,
        sfactorRGB,
        dfactorRGB,
        sfactorAlpha,
...
static void GLAD_API_PTR
glad_debug_impl_glBlendFuncSeparatei(GLuint buf, GLenum srcRGB, GLenum dstRGB, GLenum srcAlpha, GLenum dstAlpha) {
    _pre_call_gl_callback(
        "glBlendFuncSeparatei",
        (GLADapiproc)glad_glBlendFuncSeparatei,
        5,
        buf,
        srcRGB,
        dstRGB,
...
static void GLAD_API_PTR glad_debug_impl_glBlitFramebuffer(
    ...
    _pre_call_gl_callback(
        "glBlitFramebuffer",
        (GLADapiproc)glad_glBlitFramebuffer,
        10,
        srcX0,
        srcY0,
        srcX1,
...
static GLenum GLAD_API_PTR glad_debug_impl_glCheckFramebufferStatus(GLenum target) {
    ...
    _post_call_gl_callback(
        ...
        (GLADapiproc)glad_glCheckFramebufferStatus,
        1,
        target
    );
    return ret;
...
glad_debug_impl_glClearBufferfi(GLenum buffer, GLint drawbuffer, GLfloat depth, GLint stencil) {
    ...
    _post_call_gl_callback(
        NULL,
        "glClearBufferfi",
        (GLADapiproc)glad_glClearBufferfi,
        4,
        buffer,
        drawbuffer,
        depth,
...
static void GLAD_API_PTR glad_debug_impl_glCompressedTexImage1D(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glCompressedTexImage1D,
        7,
        target,
        level,
        internalformat,
...
static void GLAD_API_PTR glad_debug_impl_glCompressedTexSubImage1D(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glCompressedTexSubImage1D,
        7,
        target,
        level,
        xoffset,
...
static void GLAD_API_PTR glad_debug_impl_glCopyBufferSubData(
    ...
    _pre_call_gl_callback(
        "glCopyBufferSubData",
        (GLADapiproc)glad_glCopyBufferSubData,
        5,
        readTarget,
        writeTarget,
        readOffset,
...
static void GLAD_API_PTR glad_debug_impl_glCopyTexImage2D(
    ...
    _pre_call_gl_callback(
        "glCopyTexImage2D",
        (GLADapiproc)glad_glCopyTexImage2D,
        8,
        target,
        level,
        internalformat,
...
static void GLAD_API_PTR glad_debug_impl_glCopyTexSubImage2D(
    ...
    _pre_call_gl_callback(
        "glCopyTexSubImage2D",
        (GLADapiproc)glad_glCopyTexSubImage2D,
        8,
        target,
        level,
        xoffset,
...
static void GLAD_API_PTR glad_debug_impl_glCopyTexSubImage3D(
    ...
    _pre_call_gl_callback(
        "glCopyTexSubImage3D",
        (GLADapiproc)glad_glCopyTexSubImage3D,
        9,
        target,
        level,
        xoffset,
...
static GLuint GLAD_API_PTR
glad_debug_impl_glCreateShaderProgramv(GLenum type, GLsizei count, const GLchar* const* strings) {
    GLuint ret;
    ...
    _post_call_gl_callback(
        ...
        (GLADapiproc)glad_glCreateShaderProgramv,
        3,
        type,
        count,
        strings
...
static void GLAD_API_PTR glad_debug_impl_glDeleteProgramPipelines(GLsizei n, const GLuint* pipelines) {
    ...
    _post_call_gl_callback(
        ...
        (GLADapiproc)glad_glDeleteProgramPipelines,
        2,
        n,
        pipelines
    );
...
glad_debug_impl_glDrawArraysInstanced(GLenum mode, GLint first, GLsizei count, GLsizei instancecount) {
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glDrawArraysInstanced,
        4,
        mode,
        first,
        count,
...
static void GLAD_API_PTR glad_debug_impl_glDrawElementsBaseVertex(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glDrawElementsBaseVertex,
        5,
        mode,
        count,
        type,
...
static void GLAD_API_PTR glad_debug_impl_glDrawElementsIndirect(GLenum mode, GLenum type, const void* indirect) {
    ...
    _post_call_gl_callback(
        ...
        (GLADapiproc)glad_glDrawElementsIndirect,
        3,
        mode,
        type,
        indirect
...
static void GLAD_API_PTR glad_debug_impl_glDrawElementsInstanced(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glDrawElementsInstanced,
        5,
        mode,
        count,
        type,
...
static void GLAD_API_PTR glad_debug_impl_glDrawRangeElements(
    ...
    _pre_call_gl_callback(
        "glDrawRangeElements",
        (GLADapiproc)glad_glDrawRangeElements,
        6,
        mode,
        start,
        end,
...
static void GLAD_API_PTR glad_debug_impl_glDrawRangeElementsBaseVertex(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glDrawRangeElementsBaseVertex,
        7,
        mode,
        start,
        end,
...
static void GLAD_API_PTR glad_debug_impl_glDrawTransformFeedbackStream(GLenum mode, GLuint id, GLuint stream) {
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glDrawTransformFeedbackStream,
        3,
        mode,
        id,
        stream
...
static void GLAD_API_PTR glad_debug_impl_glFlushMappedBufferRange(GLenum target, GLintptr offset, GLsizeiptr length) {
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glFlushMappedBufferRange,
        3,
        target,
        offset,
        length
...
static void GLAD_API_PTR glad_debug_impl_glFramebufferRenderbuffer(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glFramebufferRenderbuffer,
        4,
        target,
        attachment,
        renderbuffertarget,
...
glad_debug_impl_glFramebufferTexture(GLenum target, GLenum attachment, GLuint texture, GLint level) {
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glFramebufferTexture,
        4,
        target,
        attachment,
        texture,
...
static void GLAD_API_PTR glad_debug_impl_glFramebufferTexture1D(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glFramebufferTexture1D,
        5,
        target,
        attachment,
        textarget,
...
static void GLAD_API_PTR glad_debug_impl_glFramebufferTexture2D(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glFramebufferTexture2D,
        5,
        target,
        attachment,
        textarget,
...
static void GLAD_API_PTR glad_debug_impl_glFramebufferTexture3D(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glFramebufferTexture3D,
        6,
        target,
        attachment,
        textarget,
...
glad_debug_impl_glFramebufferTextureLayer(GLenum target, GLenum attachment, GLuint texture, GLint level, GLint layer) {
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glFramebufferTextureLayer,
        5,
        target,
        attachment,
        texture,
...
static void GLAD_API_PTR glad_debug_impl_glGetActiveAttrib(
    ...
    _pre_call_gl_callback(
        "glGetActiveAttrib",
        (GLADapiproc)glad_glGetActiveAttrib,
        7,
        program,
        index,
        bufSize,
...
static void GLAD_API_PTR glad_debug_impl_glGetActiveSubroutineName(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetActiveSubroutineName,
        6,
        program,
        shadertype,
        index,
...
static void GLAD_API_PTR glad_debug_impl_glGetActiveSubroutineUniformName(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetActiveSubroutineUniformName,
        6,
        program,
        shadertype,
        index,
...
PFNGLGETACTIVESUBROUTINEUNIFORMNAMEPROC glad_debug_glGetActiveSubroutineUniformName =
...
static void GLAD_API_PTR glad_debug_impl_glGetActiveSubroutineUniformiv(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetActiveSubroutineUniformiv,
        5,
        program,
        shadertype,
        index,
...
PFNGLGETACTIVESUBROUTINEUNIFORMIVPROC glad_debug_glGetActiveSubroutineUniformiv =
...
static void GLAD_API_PTR glad_debug_impl_glGetActiveUniform(
    ...
    _pre_call_gl_callback(
        "glGetActiveUniform",
        (GLADapiproc)glad_glGetActiveUniform,
        7,
        program,
        index,
        bufSize,
...
glad_debug_impl_glGetActiveUniformBlockiv(GLuint program, GLuint uniformBlockIndex, GLenum pname, GLint* params) {
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetActiveUniformBlockiv,
        4,
        program,
        uniformBlockIndex,
        pname,
...
static void GLAD_API_PTR glad_debug_impl_glGetActiveUniformName(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetActiveUniformName,
        5,
        program,
        uniformIndex,
        bufSize,
...
static void GLAD_API_PTR glad_debug_impl_glGetActiveUniformsiv(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetActiveUniformsiv,
        5,
        program,
        uniformCount,
        uniformIndices,
...
glad_debug_impl_glGetAttachedShaders(GLuint program, GLsizei maxCount, GLsizei* count, GLuint* shaders) {
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetAttachedShaders,
        4,
        program,
        maxCount,
        count,
...
static void GLAD_API_PTR glad_debug_impl_glGetBufferParameteri64v(GLenum target, GLenum pname, GLint64* params) {
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetBufferParameteri64v,
        3,
        target,
        pname,
        params
...
static void GLAD_API_PTR glad_debug_impl_glGetBufferParameteriv(GLenum target, GLenum pname, GLint* params) {
    ...
    _post_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetBufferParameteriv,
        3,
        target,
        pname,
        params
...
static void GLAD_API_PTR glad_debug_impl_glGetBufferPointerv(GLenum target, GLenum pname, void** params) {
    ...
    _post_call_gl_callback(
        NULL,
        "glGetBufferPointerv",
        (GLADapiproc)glad_glGetBufferPointerv,
        3,
        target,
        pname,
        params
...
glad_debug_impl_glGetBufferSubData(GLenum target, GLintptr offset, GLsizeiptr size, void* data) {
    ...
    _post_call_gl_callback(
        NULL,
        "glGetBufferSubData",
        (GLADapiproc)glad_glGetBufferSubData,
        4,
        target,
        offset,
        size,
...
static void GLAD_API_PTR glad_debug_impl_glGetCompressedTexImage(GLenum target, GLint level, void* img) {
    ...
    _post_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetCompressedTexImage,
        3,
        target,
        level,
        img
...
static GLint GLAD_API_PTR glad_debug_impl_glGetFragDataLocation(GLuint program, const GLchar* name) {
    ...
    _post_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetFragDataLocation,
        2,
        program,
        name
    );
...
static void GLAD_API_PTR glad_debug_impl_glGetProgramBinary(
    ...
    _pre_call_gl_callback(
        "glGetProgramBinary",
        (GLADapiproc)glad_glGetProgramBinary,
        5,
        program,
        bufSize,
        length,
...
glad_debug_impl_glGetProgramInfoLog(GLuint program, GLsizei bufSize, GLsizei* length, GLchar* infoLog) {
    _pre_call_gl_callback(
        "glGetProgramInfoLog",
        (GLADapiproc)glad_glGetProgramInfoLog,
        4,
        program,
        bufSize,
        length,
...
static void GLAD_API_PTR
glad_debug_impl_glGetProgramPipelineInfoLog(GLuint pipeline, GLsizei bufSize, GLsizei* length, GLchar* infoLog) {
    _pre_call_gl_callback(
        "glGetProgramPipelineInfoLog",
        (GLADapiproc)glad_glGetProgramPipelineInfoLog,
        4,
        pipeline,
        bufSize,
        length,
...
static void GLAD_API_PTR glad_debug_impl_glGetProgramPipelineiv(GLuint pipeline, GLenum pname, GLint* params) {
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetProgramPipelineiv,
        3,
        pipeline,
        pname,
        params
...
static void GLAD_API_PTR
glad_debug_impl_glGetProgramStageiv(GLuint program, GLenum shadertype, GLenum pname, GLint* values) {
    _pre_call_gl_callback(
        "glGetProgramStageiv",
        (GLADapiproc)glad_glGetProgramStageiv,
        4,
        program,
        shadertype,
        pname,
...
static void GLAD_API_PTR glad_debug_impl_glGetQueryIndexediv(GLenum target, GLuint index, GLenum pname, GLint* params) {
    _pre_call_gl_callback(
        "glGetQueryIndexediv",
        (GLADapiproc)glad_glGetQueryIndexediv,
        4,
        target,
        index,
        pname,
...
static void GLAD_API_PTR glad_debug_impl_glGetQueryObjectui64v(GLuint id, GLenum pname, GLuint64* params) {
    ...
    _post_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetQueryObjectui64v,
        3,
        id,
        pname,
        params
...
static void GLAD_API_PTR glad_debug_impl_glGetRenderbufferParameteriv(GLenum target, GLenum pname, GLint* params) {
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetRenderbufferParameteriv,
        3,
        target,
        pname,
        params
...
static void GLAD_API_PTR glad_debug_impl_glGetSamplerParameterIiv(GLuint sampler, GLenum pname, GLint* params) {
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetSamplerParameterIiv,
        3,
        sampler,
        pname,
        params
...
static void GLAD_API_PTR glad_debug_impl_glGetSamplerParameterIuiv(GLuint sampler, GLenum pname, GLuint* params) {
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetSamplerParameterIuiv,
        3,
        sampler,
        pname,
        params
...
static void GLAD_API_PTR glad_debug_impl_glGetSamplerParameterfv(GLuint sampler, GLenum pname, GLfloat* params) {
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetSamplerParameterfv,
        3,
        sampler,
        pname,
        params
...
static void GLAD_API_PTR glad_debug_impl_glGetSamplerParameteriv(GLuint sampler, GLenum pname, GLint* params) {
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetSamplerParameteriv,
        3,
        sampler,
        pname,
        params
...
glad_debug_impl_glGetShaderInfoLog(GLuint shader, GLsizei bufSize, GLsizei* length, GLchar* infoLog) {
    _pre_call_gl_callback(
        "glGetShaderInfoLog",
        (GLADapiproc)glad_glGetShaderInfoLog,
        4,
        shader,
        bufSize,
        length,
...
glad_debug_impl_glGetShaderPrecisionFormat(GLenum shadertype, GLenum precisiontype, GLint* range, GLint* precision) {
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetShaderPrecisionFormat,
        4,
        shadertype,
        precisiontype,
        range,
...
glad_debug_impl_glGetShaderSource(GLuint shader, GLsizei bufSize, GLsizei* length, GLchar* source) {
    ...
    _post_call_gl_callback(
        NULL,
        "glGetShaderSource",
        (GLADapiproc)glad_glGetShaderSource,
        4,
        shader,
        bufSize,
        length,
...
static GLuint GLAD_API_PTR glad_debug_impl_glGetSubroutineIndex(GLuint program, GLenum shadertype, const GLchar* name) {
    ...
    _post_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetSubroutineIndex,
        3,
        program,
        shadertype,
        name
...
glad_debug_impl_glGetSubroutineUniformLocation(GLuint program, GLenum shadertype, const GLchar* name) {
    GLint ret;
    _pre_call_gl_callback(
        "glGetSubroutineUniformLocation",
        (GLADapiproc)glad_glGetSubroutineUniformLocation,
        3,
        program,
        shadertype,
        name
...
PFNGLGETSUBROUTINEUNIFORMLOCATIONPROC glad_debug_glGetSubroutineUniformLocation =
...
glad_debug_impl_glGetTexImage(GLenum target, GLint level, GLenum format, GLenum type, void* pixels) {
    ...
    _post_call_gl_callback(
        NULL,
        "glGetTexImage",
        (GLADapiproc)glad_glGetTexImage,
        5,
        target,
        level,
        format,
...
glad_debug_impl_glGetTexLevelParameterfv(GLenum target, GLint level, GLenum pname, GLfloat* params) {
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetTexLevelParameterfv,
        4,
        target,
        level,
        pname,
...
glad_debug_impl_glGetTexLevelParameteriv(GLenum target, GLint level, GLenum pname, GLint* params) {
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetTexLevelParameteriv,
        4,
        target,
        level,
        pname,
...
static void GLAD_API_PTR glad_debug_impl_glGetTexParameterIiv(GLenum target, GLenum pname, GLint* params) {
    ...
    _post_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetTexParameterIiv,
        3,
        target,
        pname,
        params
...
static void GLAD_API_PTR glad_debug_impl_glGetTexParameterIuiv(GLenum target, GLenum pname, GLuint* params) {
    ...
    _post_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetTexParameterIuiv,
        3,
        target,
        pname,
        params
...
static void GLAD_API_PTR glad_debug_impl_glGetTexParameterfv(GLenum target, GLenum pname, GLfloat* params) {
    ...
    _post_call_gl_callback(
        NULL,
        "glGetTexParameterfv",
        (GLADapiproc)glad_glGetTexParameterfv,
        3,
        target,
        pname,
        params
...
static void GLAD_API_PTR glad_debug_impl_glGetTexParameteriv(GLenum target, GLenum pname, GLint* params) {
    ...
    _post_call_gl_callback(
        NULL,
        "glGetTexParameteriv",
        (GLADapiproc)glad_glGetTexParameteriv,
        3,
        target,
        pname,
        params
...
static void GLAD_API_PTR glad_debug_impl_glGetTransformFeedbackVarying(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetTransformFeedbackVarying,
        7,
        program,
        index,
        bufSize,
...
static GLuint GLAD_API_PTR glad_debug_impl_glGetUniformBlockIndex(GLuint program, const GLchar* uniformBlockName) {
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetUniformBlockIndex,
        2,
        program,
        uniformBlockName
    );
...
static void GLAD_API_PTR glad_debug_impl_glGetUniformIndices(
    ...
    _pre_call_gl_callback(
        "glGetUniformIndices",
        (GLADapiproc)glad_glGetUniformIndices,
        4,
        program,
        uniformCount,
        uniformNames,
...
static GLint GLAD_API_PTR glad_debug_impl_glGetUniformLocation(GLuint program, const GLchar* name) {
    ...
    _post_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetUniformLocation,
        2,
        program,
        name
    );
...
static void GLAD_API_PTR glad_debug_impl_glGetUniformSubroutineuiv(GLenum shadertype, GLint location, GLuint* params) {
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetUniformSubroutineuiv,
        3,
        shadertype,
        location,
        params
...
static void GLAD_API_PTR glad_debug_impl_glGetVertexAttribIiv(GLuint index, GLenum pname, GLint* params) {
    ...
    _post_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetVertexAttribIiv,
        3,
        index,
        pname,
        params
...
static void GLAD_API_PTR glad_debug_impl_glGetVertexAttribIuiv(GLuint index, GLenum pname, GLuint* params) {
    ...
    _post_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetVertexAttribIuiv,
        3,
        index,
        pname,
        params
...
static void GLAD_API_PTR glad_debug_impl_glGetVertexAttribLdv(GLuint index, GLenum pname, GLdouble* params) {
    ...
    _post_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetVertexAttribLdv,
        3,
        index,
        pname,
        params
...
static void GLAD_API_PTR glad_debug_impl_glGetVertexAttribPointerv(GLuint index, GLenum pname, void** pointer) {
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glGetVertexAttribPointerv,
        3,
        index,
        pname,
        pointer
...
glad_debug_impl_glMapBufferRange(GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access) {
    ...
    _post_call_gl_callback(
        (void*)&ret,
        "glMapBufferRange",
        (GLADapiproc)glad_glMapBufferRange,
        4,
        target,
        offset,
        length,
...
glad_debug_impl_glMultiDrawArrays(GLenum mode, const GLint* first, const GLsizei* count, GLsizei drawcount) {
    ...
    _post_call_gl_callback(
        NULL,
        "glMultiDrawArrays",
        (GLADapiproc)glad_glMultiDrawArrays,
        4,
        mode,
        first,
        count,
...
static void GLAD_API_PTR glad_debug_impl_glMultiDrawElementsBaseVertex(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glMultiDrawElementsBaseVertex,
        6,
        mode,
        count,
        type,
...
glad_debug_impl_glProgramBinary(GLuint program, GLenum binaryFormat, const void* binary, GLsizei length) {
    _pre_call_gl_callback(
        "glProgramBinary",
        (GLADapiproc)glad_glProgramBinary,
        4,
        program,
        binaryFormat,
        binary,
...
static void GLAD_API_PTR glad_debug_impl_glProgramParameteri(GLuint program, GLenum pname, GLint value) {
    ...
    _post_call_gl_callback(
        NULL,
        "glProgramParameteri",
        (GLADapiproc)glad_glProgramParameteri,
        3,
        program,
        pname,
        value
...
static void GLAD_API_PTR
glad_debug_impl_glProgramUniform1dv(GLuint program, GLint location, GLsizei count, const GLdouble* value) {
    _pre_call_gl_callback(
        "glProgramUniform1dv",
        (GLADapiproc)glad_glProgramUniform1dv,
        4,
        program,
        location,
        count,
...
static void GLAD_API_PTR
glad_debug_impl_glProgramUniform1fv(GLuint program, GLint location, GLsizei count, const GLfloat* value) {
    _pre_call_gl_callback(
        "glProgramUniform1fv",
        (GLADapiproc)glad_glProgramUniform1fv,
        4,
        program,
        location,
        count,
...
static void GLAD_API_PTR
glad_debug_impl_glProgramUniform1iv(GLuint program, GLint location, GLsizei count, const GLint* value) {
    _pre_call_gl_callback(
        "glProgramUniform1iv",
        (GLADapiproc)glad_glProgramUniform1iv,
        4,
        program,
        location,
        count,
...
static void GLAD_API_PTR glad_debug_impl_glProgramUniform1ui(GLuint program, GLint location, GLuint v0) {
    ...
    _post_call_gl_callback(
        NULL,
        "glProgramUniform1ui",
        (GLADapiproc)glad_glProgramUniform1ui,
        3,
        program,
        location,
        v0
...
static void GLAD_API_PTR
glad_debug_impl_glProgramUniform1uiv(GLuint program, GLint location, GLsizei count, const GLuint* value) {
    _pre_call_gl_callback(
        "glProgramUniform1uiv",
        (GLADapiproc)glad_glProgramUniform1uiv,
        4,
        program,
        location,
        count,
...
static void GLAD_API_PTR glad_debug_impl_glProgramUniform2d(GLuint program, GLint location, GLdouble v0, GLdouble v1) {
    ...
    _post_call_gl_callback(
        NULL,
        "glProgramUniform2d",
        (GLADapiproc)glad_glProgramUniform2d,
        4,
        program,
        location,
        v0,
...
static void GLAD_API_PTR
glad_debug_impl_glProgramUniform2dv(GLuint program, GLint location, GLsizei count, const GLdouble* value) {
    _pre_call_gl_callback(
        "glProgramUniform2dv",
        (GLADapiproc)glad_glProgramUniform2dv,
        4,
        program,
        location,
        count,
...
static void GLAD_API_PTR glad_debug_impl_glProgramUniform2f(GLuint program, GLint location, GLfloat v0, GLfloat v1) {
    ...
    _post_call_gl_callback(
        NULL,
        "glProgramUniform2f",
        (GLADapiproc)glad_glProgramUniform2f,
        4,
        program,
        location,
        v0,
...
static void GLAD_API_PTR
glad_debug_impl_glProgramUniform2fv(GLuint program, GLint location, GLsizei count, const GLfloat* value) {
    _pre_call_gl_callback(
        "glProgramUniform2fv",
        (GLADapiproc)glad_glProgramUniform2fv,
        4,
        program,
        location,
        count,
...
static void GLAD_API_PTR glad_debug_impl_glProgramUniform2i(GLuint program, GLint location, GLint v0, GLint v1) {
    ...
    _post_call_gl_callback(
        NULL,
        "glProgramUniform2i",
        (GLADapiproc)glad_glProgramUniform2i,
        4,
        program,
        location,
        v0,
...
static void GLAD_API_PTR
glad_debug_impl_glProgramUniform2iv(GLuint program, GLint location, GLsizei count, const GLint* value) {
    _pre_call_gl_callback(
        "glProgramUniform2iv",
        (GLADapiproc)glad_glProgramUniform2iv,
        4,
        program,
        location,
        count,
...
static void GLAD_API_PTR glad_debug_impl_glProgramUniform2ui(GLuint program, GLint location, GLuint v0, GLuint v1) {
    ...
    _post_call_gl_callback(
        NULL,
        "glProgramUniform2ui",
        (GLADapiproc)glad_glProgramUniform2ui,
        4,
        program,
        location,
        v0,
...
static void GLAD_API_PTR
glad_debug_impl_glProgramUniform2uiv(GLuint program, GLint location, GLsizei count, const GLuint* value) {
    _pre_call_gl_callback(
        "glProgramUniform2uiv",
        (GLADapiproc)glad_glProgramUniform2uiv,
        4,
        program,
        location,
        count,
...
static void GLAD_API_PTR
glad_debug_impl_glProgramUniform3d(GLuint program, GLint location, GLdouble v0, GLdouble v1, GLdouble v2) {
    ...
    _post_call_gl_callback(
        NULL,
        "glProgramUniform3d",
        (GLADapiproc)glad_glProgramUniform3d,
        5,
        program,
        location,
        v0,
...
static void GLAD_API_PTR
glad_debug_impl_glProgramUniform3dv(GLuint program, GLint location, GLsizei count, const GLdouble* value) {
    _pre_call_gl_callback(
        "glProgramUniform3dv",
        (GLADapiproc)glad_glProgramUniform3dv,
        4,
        program,
        location,
        count,
...
static void GLAD_API_PTR
glad_debug_impl_glProgramUniform3f(GLuint program, GLint location, GLfloat v0, GLfloat v1, GLfloat v2) {
    ...
    _post_call_gl_callback(
        NULL,
        "glProgramUniform3f",
        (GLADapiproc)glad_glProgramUniform3f,
        5,
        program,
        location,
        v0,
...
static void GLAD_API_PTR
glad_debug_impl_glProgramUniform3fv(GLuint program, GLint location, GLsizei count, const GLfloat* value) {
    _pre_call_gl_callback(
        "glProgramUniform3fv",
        (GLADapiproc)glad_glProgramUniform3fv,
        4,
        program,
        location,
        count,
...
static void GLAD_API_PTR
glad_debug_impl_glProgramUniform3i(GLuint program, GLint location, GLint v0, GLint v1, GLint v2) {
    ...
    _post_call_gl_callback(
        NULL,
        "glProgramUniform3i",
        (GLADapiproc)glad_glProgramUniform3i,
        5,
        program,
        location,
        v0,
...
static void GLAD_API_PTR
glad_debug_impl_glProgramUniform3iv(GLuint program, GLint location, GLsizei count, const GLint* value) {
    _pre_call_gl_callback(
        "glProgramUniform3iv",
        (GLADapiproc)glad_glProgramUniform3iv,
        4,
        program,
        location,
        count,
...
static void GLAD_API_PTR
glad_debug_impl_glProgramUniform3ui(GLuint program, GLint location, GLuint v0, GLuint v1, GLuint v2) {
    _pre_call_gl_callback(
        "glProgramUniform3ui",
        (GLADapiproc)glad_glProgramUniform3ui,
        5,
        program,
        location,
        v0,
...
static void GLAD_API_PTR
glad_debug_impl_glProgramUniform3uiv(GLuint program, GLint location, GLsizei count, const GLuint* value) {
    _pre_call_gl_callback(
        "glProgramUniform3uiv",
        (GLADapiproc)glad_glProgramUniform3uiv,
        4,
        program,
        location,
        count,
...
static void GLAD_API_PTR
glad_debug_impl_glProgramUniform4d(GLuint program, GLint location, GLdouble v0, GLdouble v1, GLdouble v2, GLdouble v3) {
    _pre_call_gl_callback(
        "glProgramUniform4d",
        (GLADapiproc)glad_glProgramUniform4d,
        6,
        program,
        location,
        v0,
...
static void GLAD_API_PTR
glad_debug_impl_glProgramUniform4dv(GLuint program, GLint location, GLsizei count, const GLdouble* value) {
    _pre_call_gl_callback(
        "glProgramUniform4dv",
        (GLADapiproc)glad_glProgramUniform4dv,
        4,
        program,
        location,
        count,
...
static void GLAD_API_PTR
glad_debug_impl_glProgramUniform4f(GLuint program, GLint location, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3) {
    _pre_call_gl_callback(
        "glProgramUniform4f",
        (GLADapiproc)glad_glProgramUniform4f,
        6,
        program,
        location,
        v0,
...
static void GLAD_API_PTR
glad_debug_impl_glProgramUniform4fv(GLuint program, GLint location, GLsizei count, const GLfloat* value) {
    _pre_call_gl_callback(
        "glProgramUniform4fv",
        (GLADapiproc)glad_glProgramUniform4fv,
        4,
        program,
        location,
        count,
...
static void GLAD_API_PTR
glad_debug_impl_glProgramUniform4i(GLuint program, GLint location, GLint v0, GLint v1, GLint v2, GLint v3) {
    _pre_call_gl_callback(
        "glProgramUniform4i",
        (GLADapiproc)glad_glProgramUniform4i,
        6,
        program,
        location,
        v0,
...
static void GLAD_API_PTR
glad_debug_impl_glProgramUniform4iv(GLuint program, GLint location, GLsizei count, const GLint* value) {
    _pre_call_gl_callback(
        "glProgramUniform4iv",
        (GLADapiproc)glad_glProgramUniform4iv,
        4,
        program,
        location,
        count,
...
static void GLAD_API_PTR
glad_debug_impl_glProgramUniform4ui(GLuint program, GLint location, GLuint v0, GLuint v1, GLuint v2, GLuint v3) {
    _pre_call_gl_callback(
        "glProgramUniform4ui",
        (GLADapiproc)glad_glProgramUniform4ui,
        6,
        program,
        location,
        v0,
...
static void GLAD_API_PTR
glad_debug_impl_glProgramUniform4uiv(GLuint program, GLint location, GLsizei count, const GLuint* value) {
    _pre_call_gl_callback(
        "glProgramUniform4uiv",
        (GLADapiproc)glad_glProgramUniform4uiv,
        4,
        program,
        location,
        count,
...
static void GLAD_API_PTR glad_debug_impl_glProgramUniformMatrix2dv(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glProgramUniformMatrix2dv,
        5,
        program,
        location,
        count,
...
static void GLAD_API_PTR glad_debug_impl_glProgramUniformMatrix2fv(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glProgramUniformMatrix2fv,
        5,
        program,
        location,
        count,
...
static void GLAD_API_PTR glad_debug_impl_glProgramUniformMatrix2x3dv(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glProgramUniformMatrix2x3dv,
        5,
        program,
        location,
        count,
...
static void GLAD_API_PTR glad_debug_impl_glProgramUniformMatrix2x3fv(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glProgramUniformMatrix2x3fv,
        5,
        program,
        location,
        count,
...
static void GLAD_API_PTR glad_debug_impl_glProgramUniformMatrix2x4dv(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glProgramUniformMatrix2x4dv,
        5,
        program,
        location,
        count,
...
static void GLAD_API_PTR glad_debug_impl_glProgramUniformMatrix2x4fv(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glProgramUniformMatrix2x4fv,
        5,
        program,
        location,
        count,
...
static void GLAD_API_PTR glad_debug_impl_glProgramUniformMatrix3dv(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glProgramUniformMatrix3dv,
        5,
        program,
        location,
        count,
...
static void GLAD_API_PTR glad_debug_impl_glProgramUniformMatrix3fv(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glProgramUniformMatrix3fv,
        5,
        program,
        location,
        count,
...
static void GLAD_API_PTR glad_debug_impl_glProgramUniformMatrix3x2dv(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glProgramUniformMatrix3x2dv,
        5,
        program,
        location,
        count,
...
static void GLAD_API_PTR glad_debug_impl_glProgramUniformMatrix3x2fv(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glProgramUniformMatrix3x2fv,
        5,
        program,
        location,
        count,
...
static void GLAD_API_PTR glad_debug_impl_glProgramUniformMatrix3x4dv(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glProgramUniformMatrix3x4dv,
        5,
        program,
        location,
        count,
...
static void GLAD_API_PTR glad_debug_impl_glProgramUniformMatrix3x4fv(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glProgramUniformMatrix3x4fv,
        5,
        program,
        location,
        count,
...
static void GLAD_API_PTR glad_debug_impl_glProgramUniformMatrix4dv(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glProgramUniformMatrix4dv,
        5,
        program,
        location,
        count,
...
static void GLAD_API_PTR glad_debug_impl_glProgramUniformMatrix4fv(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glProgramUniformMatrix4fv,
        5,
        program,
        location,
        count,
...
static void GLAD_API_PTR glad_debug_impl_glProgramUniformMatrix4x2dv(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glProgramUniformMatrix4x2dv,
        5,
        program,
        location,
        count,
...
static void GLAD_API_PTR glad_debug_impl_glProgramUniformMatrix4x2fv(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glProgramUniformMatrix4x2fv,
        5,
        program,
        location,
        count,
...
static void GLAD_API_PTR glad_debug_impl_glProgramUniformMatrix4x3dv(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glProgramUniformMatrix4x3dv,
        5,
        program,
        location,
        count,
...
static void GLAD_API_PTR glad_debug_impl_glProgramUniformMatrix4x3fv(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glProgramUniformMatrix4x3fv,
        5,
        program,
        location,
        count,
...
glad_debug_impl_glRenderbufferStorage(GLenum target, GLenum internalformat, GLsizei width, GLsizei height) {
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glRenderbufferStorage,
        4,
        target,
        internalformat,
        width,
...
static void GLAD_API_PTR glad_debug_impl_glSamplerParameterf(GLuint sampler, GLenum pname, GLfloat param) {
    ...
    _post_call_gl_callback(
        NULL,
        "glSamplerParameterf",
        (GLADapiproc)glad_glSamplerParameterf,
        3,
        sampler,
        pname,
        param
...
static void GLAD_API_PTR glad_debug_impl_glSamplerParameterfv(GLuint sampler, GLenum pname, const GLfloat* param) {
    ...
    _post_call_gl_callback(
        ...
        (GLADapiproc)glad_glSamplerParameterfv,
        3,
        sampler,
        pname,
        param
...
static void GLAD_API_PTR glad_debug_impl_glSamplerParameteri(GLuint sampler, GLenum pname, GLint param) {
    ...
    _post_call_gl_callback(
        NULL,
        "glSamplerParameteri",
        (GLADapiproc)glad_glSamplerParameteri,
        3,
        sampler,
        pname,
        param
...
static void GLAD_API_PTR glad_debug_impl_glSamplerParameteriv(GLuint sampler, GLenum pname, const GLint* param) {
    ...
    _post_call_gl_callback(
        ...
        (GLADapiproc)glad_glSamplerParameteriv,
        3,
        sampler,
        pname,
        param
...
static void GLAD_API_PTR
glad_debug_impl_glScissorIndexed(GLuint index, GLint left, GLint bottom, GLsizei width, GLsizei height) {
    _pre_call_gl_callback(
        "glScissorIndexed",
        (GLADapiproc)glad_glScissorIndexed,
        5,
        index,
        left,
        bottom,
...
static void GLAD_API_PTR glad_debug_impl_glShaderBinary(
    ...
    _pre_call_gl_callback(
        "glShaderBinary",
        (GLADapiproc)glad_glShaderBinary,
        5,
        count,
        shaders,
        binaryFormat,
...
static void GLAD_API_PTR glad_debug_impl_glStencilFuncSeparate(GLenum face, GLenum func, GLint ref, GLuint mask) {
    ...
    _post_call_gl_callback(
        ...
        (GLADapiproc)glad_glStencilFuncSeparate,
        4,
        face,
        func,
        ref,
...
static void GLAD_API_PTR glad_debug_impl_glStencilOpSeparate(GLenum face, GLenum sfail, GLenum dpfail, GLenum dppass) {
    ...
    _post_call_gl_callback(
        NULL,
        "glStencilOpSeparate",
        (GLADapiproc)glad_glStencilOpSeparate,
        4,
        face,
        sfail,
        dpfail,
...
static void GLAD_API_PTR glad_debug_impl_glTexSubImage1D(
    ...
    _pre_call_gl_callback(
        "glTexSubImage1D",
        (GLADapiproc)glad_glTexSubImage1D,
        7,
        target,
        level,
        xoffset,
...
static void GLAD_API_PTR glad_debug_impl_glTexSubImage2D(
    ...
    _pre_call_gl_callback(
        "glTexSubImage2D",
        (GLADapiproc)glad_glTexSubImage2D,
        9,
        target,
        level,
        xoffset,
...
static void GLAD_API_PTR glad_debug_impl_glTransformFeedbackVaryings(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glTransformFeedbackVaryings,
        4,
        program,
        count,
        varyings,
...
glad_debug_impl_glUniformBlockBinding(GLuint program, GLuint uniformBlockIndex, GLuint uniformBlockBinding) {
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glUniformBlockBinding,
        3,
        program,
        uniformBlockIndex,
        uniformBlockBinding
...
static void GLAD_API_PTR
glad_debug_impl_glUniformMatrix2dv(GLint location, GLsizei count, GLboolean transpose, const GLdouble* value) {
    _pre_call_gl_callback(
        "glUniformMatrix2dv",
        (GLADapiproc)glad_glUniformMatrix2dv,
        4,
        location,
        count,
        transpose,
...
glad_debug_impl_glUniformMatrix2fv(GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) {
    _pre_call_gl_callback(
        "glUniformMatrix2fv",
        (GLADapiproc)glad_glUniformMatrix2fv,
        4,
        location,
        count,
        transpose,
...
static void GLAD_API_PTR
glad_debug_impl_glUniformMatrix2x3dv(GLint location, GLsizei count, GLboolean transpose, const GLdouble* value) {
    _pre_call_gl_callback(
        "glUniformMatrix2x3dv",
        (GLADapiproc)glad_glUniformMatrix2x3dv,
        4,
        location,
        count,
        transpose,
...
glad_debug_impl_glUniformMatrix2x3fv(GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) {
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glUniformMatrix2x3fv,
        4,
        location,
        count,
        transpose,
...
static void GLAD_API_PTR
glad_debug_impl_glUniformMatrix2x4dv(GLint location, GLsizei count, GLboolean transpose, const GLdouble* value) {
    _pre_call_gl_callback(
        "glUniformMatrix2x4dv",
        (GLADapiproc)glad_glUniformMatrix2x4dv,
        4,
        location,
        count,
        transpose,
...
glad_debug_impl_glUniformMatrix2x4fv(GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) {
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glUniformMatrix2x4fv,
        4,
        location,
        count,
        transpose,
...
static void GLAD_API_PTR
glad_debug_impl_glUniformMatrix3dv(GLint location, GLsizei count, GLboolean transpose, const GLdouble* value) {
    _pre_call_gl_callback(
        "glUniformMatrix3dv",
        (GLADapiproc)glad_glUniformMatrix3dv,
        4,
        location,
        count,
        transpose,
...
glad_debug_impl_glUniformMatrix3fv(GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) {
    _pre_call_gl_callback(
        "glUniformMatrix3fv",
        (GLADapiproc)glad_glUniformMatrix3fv,
        4,
        location,
        count,
        transpose,
...
static void GLAD_API_PTR
glad_debug_impl_glUniformMatrix3x2dv(GLint location, GLsizei count, GLboolean transpose, const GLdouble* value) {
    _pre_call_gl_callback(
        "glUniformMatrix3x2dv",
        (GLADapiproc)glad_glUniformMatrix3x2dv,
        4,
        location,
        count,
        transpose,
...
static void GLAD_API_PTR
glad_debug_impl_glUniformMatrix3x4dv(GLint location, GLsizei count, GLboolean transpose, const GLdouble* value) {
    _pre_call_gl_callback(
        "glUniformMatrix3x4dv",
        (GLADapiproc)glad_glUniformMatrix3x4dv,
        4,
        location,
        count,
        transpose,
...
glad_debug_impl_glUniformMatrix3x4fv(GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) {
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glUniformMatrix3x4fv,
        4,
        location,
        count,
        transpose,
...
static void GLAD_API_PTR
glad_debug_impl_glUniformMatrix4dv(GLint location, GLsizei count, GLboolean transpose, const GLdouble* value) {
    _pre_call_gl_callback(
        "glUniformMatrix4dv",
        (GLADapiproc)glad_glUniformMatrix4dv,
        4,
        location,
        count,
        transpose,
...
glad_debug_impl_glUniformMatrix4fv(GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) {
    _pre_call_gl_callback(
        "glUniformMatrix4fv",
        (GLADapiproc)glad_glUniformMatrix4fv,
        4,
        location,
        count,
        transpose,
...
static void GLAD_API_PTR
glad_debug_impl_glUniformMatrix4x2dv(GLint location, GLsizei count, GLboolean transpose, const GLdouble* value) {
    _pre_call_gl_callback(
        "glUniformMatrix4x2dv",
        (GLADapiproc)glad_glUniformMatrix4x2dv,
        4,
        location,
        count,
        transpose,
...
glad_debug_impl_glUniformMatrix4x2fv(GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) {
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glUniformMatrix4x2fv,
        4,
        location,
        count,
        transpose,
...
static void GLAD_API_PTR
glad_debug_impl_glUniformMatrix4x3dv(GLint location, GLsizei count, GLboolean transpose, const GLdouble* value) {
    _pre_call_gl_callback(
        "glUniformMatrix4x3dv",
        (GLADapiproc)glad_glUniformMatrix4x3dv,
        4,
        location,
        count,
        transpose,
...
glad_debug_impl_glUniformMatrix4x3fv(GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) {
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glUniformMatrix4x3fv,
        4,
        location,
        count,
        transpose,
...
static void GLAD_API_PTR
glad_debug_impl_glUniformSubroutinesuiv(GLenum shadertype, GLsizei count, const GLuint* indices) {
    _pre_call_gl_callback(
        "glUniformSubroutinesuiv",
        (GLADapiproc)glad_glUniformSubroutinesuiv,
        3,
        shadertype,
        count,
        indices
...
static void GLAD_API_PTR glad_debug_impl_glUseProgramStages(GLuint pipeline, GLbitfield stages, GLuint program) {
    ...
    _post_call_gl_callback(
        NULL,
        "glUseProgramStages",
        (GLADapiproc)glad_glUseProgramStages,
        3,
        pipeline,
        stages,
        program
...
glad_debug_impl_glVertexAttribIPointer(GLuint index, GLint size, GLenum type, GLsizei stride, const void* pointer) {
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glVertexAttribIPointer,
        5,
        index,
        size,
        type,
...
static void GLAD_API_PTR
glad_debug_impl_glVertexAttribL4d(GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w) {
...
static void GLAD_API_PTR
glad_debug_impl_glVertexAttribLPointer(GLuint index, GLint size, GLenum type, GLsizei stride, const void* pointer) {
    _pre_call_gl_callback(
        "glVertexAttribLPointer",
        (GLADapiproc)glad_glVertexAttribLPointer,
        5,
        index,
        size,
        type,
...
glad_debug_impl_glVertexAttribP1ui(GLuint index, GLenum type, GLboolean normalized, GLuint value) {
    _pre_call_gl_callback(
        "glVertexAttribP1ui",
        (GLADapiproc)glad_glVertexAttribP1ui,
        4,
        index,
        type,
        normalized,
...
glad_debug_impl_glVertexAttribP1uiv(GLuint index, GLenum type, GLboolean normalized, const GLuint* value) {
    _pre_call_gl_callback(
        "glVertexAttribP1uiv",
        (GLADapiproc)glad_glVertexAttribP1uiv,
        4,
        index,
        type,
        normalized,
...
glad_debug_impl_glVertexAttribP2ui(GLuint index, GLenum type, GLboolean normalized, GLuint value) {
    _pre_call_gl_callback(
        "glVertexAttribP2ui",
        (GLADapiproc)glad_glVertexAttribP2ui,
        4,
        index,
        type,
        normalized,
...
glad_debug_impl_glVertexAttribP2uiv(GLuint index, GLenum type, GLboolean normalized, const GLuint* value) {
    _pre_call_gl_callback(
        "glVertexAttribP2uiv",
        (GLADapiproc)glad_glVertexAttribP2uiv,
        4,
        index,
        type,
        normalized,
...
glad_debug_impl_glVertexAttribP3ui(GLuint index, GLenum type, GLboolean normalized, GLuint value) {
    _pre_call_gl_callback(
        "glVertexAttribP3ui",
        (GLADapiproc)glad_glVertexAttribP3ui,
        4,
        index,
        type,
        normalized,
...
glad_debug_impl_glVertexAttribP3uiv(GLuint index, GLenum type, GLboolean normalized, const GLuint* value) {
    _pre_call_gl_callback(
        "glVertexAttribP3uiv",
        (GLADapiproc)glad_glVertexAttribP3uiv,
        4,
        index,
        type,
        normalized,
...
glad_debug_impl_glVertexAttribP4ui(GLuint index, GLenum type, GLboolean normalized, GLuint value) {
    _pre_call_gl_callback(
        "glVertexAttribP4ui",
        (GLADapiproc)glad_glVertexAttribP4ui,
        4,
        index,
        type,
        normalized,
...
glad_debug_impl_glVertexAttribP4uiv(GLuint index, GLenum type, GLboolean normalized, const GLuint* value) {
    _pre_call_gl_callback(
        "glVertexAttribP4uiv",
        (GLADapiproc)glad_glVertexAttribP4uiv,
        4,
        index,
        type,
        normalized,
...
static void GLAD_API_PTR glad_debug_impl_glVertexAttribPointer(
    ...
    _pre_call_gl_callback(
        ...
        (GLADapiproc)glad_glVertexAttribPointer,
        6,
        index,
        size,
        type,
